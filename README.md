...
1. 将精简数据集传至hdfs上
   ...
   ![image-20191129221804837](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129221804837.png)

2. 将代码打包后执行**第一个MapReduce程序**

   `elevencount.itemBeanhadoop jar eleven.jar elevenbuy.countDriver input5 output7_1`

   ![image-20191129223155736](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129223155736.png)

   ![image-20191129223310574](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129223310574.png)
...
3. 将第一个MapReduce的输出作为第二个MapReduce程序的输入
   ...
   ![image-20191129223629202](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129223629202.png)

4. 执行第二个MapReduce程序

   `hadoop jar eleven.jar popularitem.countDriver input8 output8`

   ![image-20191129223812256](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129223812256.png)

5. 第二个MapReduce程序将分省排序的结果输出，每个省独立一个输出

   ![image-20191129224014285](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129224014285.png)

   ![image-20191129224037574](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129224037574.png)
...
6. 把结果从hdfs拿下来
   ...
   ![image-20191129224522586](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129224522586.png)
...
7. 以福建省为例，对应输出文件part-r-00003，看一下结果：
   ...
   ![image-20191129225022547](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129225022547.png)
...
1. 先用wget方法从清华大学的镜像上下载Hive-3.1.2
   ...
   ![image-20191129230219997](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129230219997.png)
...
3. 配置hive-env.sh
   ...
   ![image-20191129231008278](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129231008278.png)
...
- 看一看导入的表格
  ...
  ![image-20191129232719891](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129232719891.png)
...
![image-20191129232940627](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129232940627.png)
...
![image-20191129234705544](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129234705544.png)
...
![image-20191129233330204](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129233330204.png)

`select count(*) from eleven where gender='0' and action=2;`

![image-20191129233446359](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129233446359.png)

所以，有39058/334018=11.69%的女性购买了商品

`select count(*) from eleven where gender='1';`

![image-20191129233638477](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129233638477.png)

`select count(*) from eleven where gender='1' and action=2;`

![image-20191129233727445](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129233727445.png)
...
![image-20191129233927178](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129233927178.png)

浏览次数前十的品牌为：

![image-20191129234009086](C:\Users\Explorer\AppData\Roaming\Typora\typora-user-images\image-20191129234009086.png)
